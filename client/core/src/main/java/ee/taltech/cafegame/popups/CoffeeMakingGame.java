...
public class CoffeeMakingGame extends Window {
    ...
    private final int[] requiredKeySequence = {
        Input.Keys.L, Input.Keys.A, Input.Keys.T, Input.Keys.T, Input.Keys.E
    };

    public CoffeeMakingGame(String orderText, Skin skin, OrderPopup.OrderAcceptedListener listener) {
        super("", skin);
        setDefaults();
        ...
        Texture gameTexture = new Texture(Gdx.files.internal("skin/lattegame.png"));
