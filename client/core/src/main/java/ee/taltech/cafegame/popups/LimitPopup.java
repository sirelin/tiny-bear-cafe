...
public class LimitPopup extends Window {

    public LimitPopup(String imagePath) {
        ...
        float popupWidth = Gdx.graphics.getWidth() * 0.4f;
        float popupHeight = Gdx.graphics.getHeight() * 0.3f;
